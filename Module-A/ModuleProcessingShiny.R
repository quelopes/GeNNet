moduleProcessingShiny = function(nameExp,orgAnnot,normMeth,overalDesign,platName,platAccess,FDR,logFC,mClust,matDist){
  
  # ======================
  # === Configurations ===
  # ======================
  
  shinyDir = "/srv/shiny-server/gennet/"
  rstudioDir = "/home/rstudio/"
  
  GPL = paste(platAccess,".txt",sep="")
  ...
  # --- write the results ---
  dirW = paste(rstudioDir,"Results/",sep="")
  ...
  # === NORMALIZED ===
  ddg.start("normalize")
  GeNNet = pre_Raw(dirR_raw,dirW,pheno,normMeth,nameExp)
